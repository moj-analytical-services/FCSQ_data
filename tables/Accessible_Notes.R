...
#Table 19 notes
t19_note_len <- length(t19_notes)
t19_note_section <- note_section(t19_notes, 'Table 19', note_number)
note_number <- note_number + t19_note_len

#Table 20 notes
t20_note_len <- length(t20_notes)
t20_note_section <- note_section(t20_notes, 'Table 20', note_number)
note_number <- note_number + t20_note_len

#Table 21 notes
t21_note_len <- length(t21_notes)
t21_note_section <- note_section(t21_notes, 'Table 21', note_number)
note_number <- note_number + t21_note_len

#Table 22 notes
t22_note_len <- length(t22_notes)
t22_note_section <- note_section(t22_notes, 'Table 22', note_number)
note_number <- note_number + t22_note_len

#Table 23 notes
t23_note_len <- length(t23_notes)
t23_note_section <- note_section(t23_notes, 'Table 23', note_number)
note_number <- note_number + t23_note_len

#Table 24 notes
t24_note_len <- length(t24_notes)
t24_note_section <- note_section(t24_notes, 'Table 24', note_number)
note_number <- note_number + t24_note_len

#Table 25 notes
t25_note_len <- length(t25_notes)
t25_note_section <- note_section(t25_notes, 'Table 25', note_number)
note_number <- note_number + t25_note_len
...
notes_all <- bind_rows(t1_note_section, t2_note_section,
                       ...
                       t19_note_section, t20_note_section,
                       t21_note_section, t22_note_section,
                       t23_note_section, t24_note_section, t25_note_section)