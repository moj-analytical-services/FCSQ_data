...
full_t24 <- tibble(Year = probate_dates$Year,
                   ...
                   grant_reseal_apps = glue('=IFERROR(VLOOKUP($A{probate_rows}&"|"&$B{probate_rows}&"|"&${t24_list_letter}${t24_list_a_row}&"|"&F$12&"|"&${t24_list_letter}${t24_list_b_row},\'Table 23 source\'!$A:$H,8, FALSE),0)'),
                   all_grant_apps = glue('=VLOOKUP($A{probate_rows}&"|"&$B{probate_rows}&"|"&${t24_list_letter}${t24_list_a_row}&"|"&G$12&"|"&${t24_list_letter}${t24_list_b_row},\'Table 23 source\'!$A:$H,8, FALSE)'),
                   blank1 = NA,
                   probate_issued = glue('=VLOOKUP($A{probate_rows}&"|"&$B{probate_rows}&"|"&${t24_list_letter}${t24_list_a_row}&"|"&I$12&"|"&${t24_list_letter}${t24_list_b_row},\'Table 23 source\'!$A:$H,7, FALSE)'),
                   grant_will_issued = glue('=VLOOKUP($A{probate_rows}&"|"&$B{probate_rows}&"|"&${t24_list_letter}${t24_list_a_row}&"|"&J$12&"|"&${t24_list_letter}${t24_list_b_row},\'Table 23 source\'!$A:$H,7, FALSE)'),
                   grant_admin_issued = glue('=VLOOKUP($A{probate_rows}&"|"&$B{probate_rows}&"|"&${t24_list_letter}${t24_list_a_row}&"|"&K$12&"|"&${t24_list_letter}${t24_list_b_row},\'Table 23 source\'!$A:$H,7, FALSE)'),
                   grant_reseal_issued = glue('=IFERROR(VLOOKUP($A{probate_rows}&"|"&$B{probate_rows}&"|"&${t24_list_letter}${t24_list_a_row}&"|"&L$12&"|"&${t24_list_letter}${t24_list_b_row},\'Table 23 source\'!$A:$H,7, FALSE),0)'),
                   all_grant_issued = glue('=VLOOKUP($A{probate_rows}&"|"&$B{probate_rows}&"|"&${t24_list_letter}${t24_list_a_row}&"|"&M$12&"|"&${t24_list_letter}${t24_list_b_row},\'Table 23 source\'!$A:$H,7, FALSE)'),
                   blank2 = NA,
                   grants_revoked = glue('=VLOOKUP($A{probate_rows}&"|"&$B{probate_rows}&"|"&${t24_list_letter}${t24_list_a_row}&"|"&O$12&"|"&${t24_list_letter}${t24_list_b_row},\'Table 23 source\'!$A:$H,7, FALSE)'),
                   standing_search = glue('=VLOOKUP($A{probate_rows}&"|"&$B{probate_rows}&"|"&${t24_list_letter}${t24_list_a_row}&"|"&P$12&"|"&${t24_list_letter}${t24_list_b_row},\'Table 23 source\'!$A:$H,7, FALSE)'),
