...
adopt_ords_male_child_year <- adopt_csv %>% 
  ...
  group_by(Year) %>% 
  summarise(male_child = sum_na(Count))
...
adopt_ords_female_child_year <- adopt_csv %>% 
  ...
  group_by(Year) %>% 
  summarise(female_child = sum_na(Count))
...
adopt_ords_one_year <- adopt_csv %>% 
  ...
  group_by(Year) %>% 
  summarise(less_than_one = sum_na(Count))
...
adopt_ords_four_year <- adopt_csv %>% 
  ...
  group_by(Year) %>% 
  summarise(one_to_four = sum_na(Count))
...
adopt_ords_nine_year <- adopt_csv %>% 
  ...
  group_by(Year) %>% 
  summarise(five_to_nine = sum_na(Count))
...
adopt_ords_fourteen_year <- adopt_csv %>% 
  ...
  group_by(Year) %>% 
  summarise(ten_to_fourteen = sum_na(Count))
...
adopt_ords_seventeen_year <- adopt_csv %>% 
  ...
  group_by(Year) %>% 
  summarise(fifteen_to_seventeen = sum_na(Count))
...
adopt_ords_other_age_year <- adopt_csv %>% 
  ...
  group_by(Year) %>% 
  summarise(other_age = sum_na(Count))
...
adopt_ords_unknown_age_year <- adopt_csv %>% 
  ...
  group_by(Year) %>% 
  summarise(unknown_age = sum_na(Count))
...
adopt_ords_total_adopt_year <- adopt_csv %>% 
  ...
  group_by(Year) %>% 
  summarise(total_adopt_ords = sum_na(Count))
...
adopt_ords_other_disps_year <- adopt_csv %>% 
  ...
  group_by(Year) %>% 
  summarise(other_disps = sum_na(Count))
...
adopt_ords_case_close_year <- adopt_csv %>% 
  ...
  group_by(Year) %>% 
  summarise(case_close = sum_na(Count))
