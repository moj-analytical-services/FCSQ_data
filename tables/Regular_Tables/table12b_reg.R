...
div_qtr_new <- tibble(Year = current_div_qtr_new$Year,
                  ...
                  ,
                  n_apps = glue('=IF(SUMIFS(Table_12b_source!$H:$H,Table_12b_source!$D:$D,$A{div_qtr_row_seq_new}&" "&LEFT($B{div_qtr_row_seq_new},2),Table_12b_source!$B:$B,L$5,Table_12b_source!$A:$A,$L$12,Table_12b_source!$E:$E,${t12b_list_letter}${t12b_list_a_row})=0,".",SUMIFS(Table_12b_source!$H:$H,Table_12b_source!$D:$D,$A{div_qtr_row_seq_new}&" "&LEFT($B{div_qtr_row_seq_new},2),Table_12b_source!$B:$B,L$5,Table_12b_source!$A:$A,$L$12,Table_12b_source!$E:$E,${t12b_list_letter}${t12b_list_a_row}))')
                  ,
                  n_cond = glue('=IF(SUMIFS(Table_12b_source!$H:$H,Table_12b_source!$D:$D,$A{div_qtr_row_seq_new}&" "&LEFT($B{div_qtr_row_seq_new},2),Table_12b_source!$B:$B,M$5,Table_12b_source!$A:$A,$L$12,Table_12b_source!$E:$E,${t12b_list_letter}${t12b_list_a_row})=0,".",SUMIFS(Table_12b_source!$H:$H,Table_12b_source!$D:$D,$A{div_qtr_row_seq_new}&" "&LEFT($B{div_qtr_row_seq_new},2),Table_12b_source!$B:$B,M$5,Table_12b_source!$A:$A,$L$12,Table_12b_source!$E:$E,${t12b_list_letter}${t12b_list_a_row}))')
                  ,
                  n_final = glue('=IF(SUMIFS(Table_12b_source!$H:$H,Table_12b_source!$D:$D,$A{div_qtr_row_seq_new}&" "&LEFT($B{div_qtr_row_seq_new},2),Table_12b_source!$B:$B,N$5,Table_12b_source!$A:$A,$L$12,Table_12b_source!$E:$E,${t12b_list_letter}${t12b_list_a_row})=0,".",SUMIFS(Table_12b_source!$H:$H,Table_12b_source!$D:$D,$A{div_qtr_row_seq_new}&" "&LEFT($B{div_qtr_row_seq_new},2),Table_12b_source!$B:$B,N$5,Table_12b_source!$A:$A,$L$12,Table_12b_source!$E:$E,${t12b_list_letter}${t12b_list_a_row}))')
                  ,
                  j_apps = glue('=IF(SUMIFS(Table_12b_source!$H:$H,Table_12b_source!$D:$D,$A{div_qtr_row_seq_new}&" "&LEFT($B{div_qtr_row_seq_new},2),Table_12b_source!$B:$B,P$5,Table_12b_source!$A:$A,$P$12,Table_12b_source!$E:$E,${t12b_list_letter}${t12b_list_a_row})=0,".",SUMIFS(Table_12b_source!$H:$H,Table_12b_source!$D:$D,$A{div_qtr_row_seq_new}&" "&LEFT($B{div_qtr_row_seq_new},2),Table_12b_source!$B:$B,P$5,Table_12b_source!$A:$A,$P$12,Table_12b_source!$E:$E,${t12b_list_letter}${t12b_list_a_row}))')
                  ,
                  j_final = glue('=IF(SUMIFS(Table_12b_source!$H:$H,Table_12b_source!$D:$D,$A{div_qtr_row_seq_new}&" "&LEFT($B{div_qtr_row_seq_new},2),Table_12b_source!$B:$B,Q$5,Table_12b_source!$A:$A,$P$12,Table_12b_source!$E:$E,${t12b_list_letter}${t12b_list_a_row})=0,".",SUMIFS(Table_12b_source!$H:$H,Table_12b_source!$D:$D,$A{div_qtr_row_seq_new}&" "&LEFT($B{div_qtr_row_seq_new},2),Table_12b_source!$B:$B,Q$5,Table_12b_source!$A:$A,$P$12,Table_12b_source!$E:$E,${t12b_list_letter}${t12b_list_a_row}))')
