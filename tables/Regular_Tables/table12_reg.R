...
div_year <- tibble(Year = current_div_year,
                  ...
                  ,
                  n_decrees_abs = glue('=IF(SUMIFS(Table_12_source!$G:$G,Table_12_source!$C:$C,$A{div_year_row_seq},Table_12_source!$B:$B,N$6,Table_12_source!$A:$A,$L$13,Table_12_source!$F:$F,${t12_list_letter}${t12_list_a_row},Table_12_source!$E:$E,${t12_list_letter}${t12_list_b_row})=0,".",SUMIFS(Table_12_source!$G:$G,Table_12_source!$C:$C,$A{div_year_row_seq},Table_12_source!$B:$B,N$6,Table_12_source!$A:$A,$L$13,Table_12_source!$F:$F,${t12_list_letter}${t12_list_a_row},Table_12_source!$E:$E,${t12_list_letter}${t12_list_b_row}))')
                  ,
                  j_pet_filed = glue('=IF(SUMIFS(Table_12_source!$G:$G,Table_12_source!$C:$C,$A{div_year_row_seq},Table_12_source!$B:$B,P$6,Table_12_source!$A:$A,$P$13,Table_12_source!$F:$F,${t12_list_letter}${t12_list_a_row},Table_12_source!$E:$E,${t12_list_letter}${t12_list_b_row})=0,".",SUMIFS(Table_12_source!$G:$G,Table_12_source!$C:$C,$A{div_year_row_seq},Table_12_source!$B:$B,P$6,Table_12_source!$A:$A,$P$13,Table_12_source!$F:$F,${t12_list_letter}${t12_list_a_row},Table_12_source!$E:$E,${t12_list_letter}${t12_list_b_row}))')
                  ,
                  j_decrees_granted = glue('=IF(SUMIFS(Table_12_source!$G:$G,Table_12_source!$C:$C,$A{div_year_row_seq},Table_12_source!$B:$B,Q$6,Table_12_source!$A:$A,$P$13,Table_12_source!$F:$F,${t12_list_letter}${t12_list_a_row},Table_12_source!$E:$E,${t12_list_letter}${t12_list_b_row})=0,".",SUMIFS(Table_12_source!$G:$G,Table_12_source!$C:$C,$A{div_year_row_seq},Table_12_source!$B:$B,Q$6,Table_12_source!$A:$A,$P$13,Table_12_source!$F:$F,${t12_list_letter}${t12_list_a_row},Table_12_source!$E:$E,${t12_list_letter}${t12_list_b_row}))')
                  ,
...
div_qtr <- tibble(Year = current_div_qtr$Year,
                   ...
                   ,
                   n_decrees_abs = glue('=IF(SUMIFS(Table_12_source!$G:$G,Table_12_source!$D:$D,$A{div_qtr_row_seq} & " " &LEFT($B{div_qtr_row_seq},2),Table_12_source!$B:$B,N$6,Table_12_source!$A:$A,$L$13,Table_12_source!$F:$F,${t12_list_letter}${t12_list_a_row},Table_12_source!$E:$E,${t12_list_letter}${t12_list_b_row})=0,".",SUMIFS(Table_12_source!$G:$G,Table_12_source!$D:$D,$A{div_qtr_row_seq} & " " &LEFT($B{div_qtr_row_seq},2),Table_12_source!$B:$B,N$6,Table_12_source!$A:$A,$L$13,Table_12_source!$F:$F,${t12_list_letter}${t12_list_a_row},Table_12_source!$E:$E,${t12_list_letter}${t12_list_b_row}))')
                   ,
                   j_pet_filed = glue('=IF(SUMIFS(Table_12_source!$G:$G,Table_12_source!$D:$D,$A{div_qtr_row_seq} & " " &LEFT($B{div_qtr_row_seq},2),Table_12_source!$B:$B,P$6,Table_12_source!$A:$A,$P$13,Table_12_source!$F:$F,${t12_list_letter}${t12_list_a_row},Table_12_source!$E:$E,${t12_list_letter}${t12_list_b_row})=0,".",SUMIFS(Table_12_source!$G:$G,Table_12_source!$D:$D,$A{div_qtr_row_seq} & " " &LEFT($B{div_qtr_row_seq},2),Table_12_source!$B:$B,P$6,Table_12_source!$A:$A,$P$13,Table_12_source!$F:$F,${t12_list_letter}${t12_list_a_row},Table_12_source!$E:$E,${t12_list_letter}${t12_list_b_row}))')
                   ,
                   j_decrees_granted = glue('=IF(SUMIFS(Table_12_source!$G:$G,Table_12_source!$D:$D,$A{div_qtr_row_seq} & " " &LEFT($B{div_qtr_row_seq},2),Table_12_source!$B:$B,Q$6,Table_12_source!$A:$A,$P$13,Table_12_source!$F:$F,${t12_list_letter}${t12_list_a_row},Table_12_source!$E:$E,${t12_list_letter}${t12_list_b_row})=0,".",SUMIFS(Table_12_source!$G:$G,Table_12_source!$D:$D,$A{div_qtr_row_seq} & " " &LEFT($B{div_qtr_row_seq},2),Table_12_source!$B:$B,Q$6,Table_12_source!$A:$A,$P$13,Table_12_source!$F:$F,${t12_list_letter}${t12_list_a_row},Table_12_source!$E:$E,${t12_list_letter}${t12_list_b_row}))')
                   ,
