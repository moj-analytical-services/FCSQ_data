...
dol_hc_csv <- read_using(readr::read_csv, paste0(csv_folder, 'CSV High Court Deprivation of Liberty', " ", pub_year, " Q", pub_quarter, ' - Region level.csv'), na = na_keys) %>% rename_with(str_to_title)
